...
int mem_cgroup_css_free_probe(struct pt_regs *ctx, struct cgroup_subsys_state *css)
{
    u64 memcg_ptr = (u64)PT_REGS_PARM1(ctx);
...
b.attach_kprobe(event="mem_cgroup_css_free", fn_name="mem_cgroup_css_free_probe")
